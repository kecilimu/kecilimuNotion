...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2bb4d67f9a484014a71875a47820d2ca,en:2bb4d67f9a484014a71875a47820d2ca',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hope & Peace', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kecilimu-notion.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, AI, math, physics, DL, ML', // 网站关键词 英文逗号隔开
