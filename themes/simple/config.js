const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>HFUT Mathematics&Applied Mathematics<br/>/Machine Learning<br/>/Condensed Matter Physics</div>',
